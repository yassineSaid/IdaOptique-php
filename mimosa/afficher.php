											...
											<table>
												<thead>
													<tr>
														...
														<th class="product-subtotal">ya rabbi tsahhel </th>
													</tr>
												</thead>
												<tbody>
													<?php 
													...
													<tr>
														...
														<td><p align="center"><a type='submit' name='' value="Modifier" style="background: #000 none repeat scroll 0 0;
														  ...
														  width: 260px;"  <?php if ( $row["statut"] != "en attente"){ ?> disabled="true" <?php   } echo "<a href=afficheraa.php?id=".$row['id_client']."&id_commande=".$row['id_commande'].""?> >Modifier </a></p></td>
													</tr>
