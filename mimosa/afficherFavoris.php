					...
					<div class="row">
						<div class="col-lg-12">
							<div class="breadcrumb-content text-center">
								...
								<ul>
									<li><a href="#">Home /</a></li>
									<li class="active"><a href="#">Favoris/a></li>
								</ul>
							</div>
						</div>
					</div>
									...
									<form action="#">
										<div class="wishlist-table table-responsive">
											...
											<table>
												<thead>
													...
													<tr>
														...
														<th class="product-name">ID Client</th>
														<th class="product-name">ID Produit</th>
											...
											require'../core/favorisC.php'; 
													   ...
													   <tr>
														<td class="product-price"><span class="amount"><?php echo $row['id_client'];?></span></td>
														<td class="product-price"><span class="amount"><?php echo $row['produit_id'];?></span></td>
