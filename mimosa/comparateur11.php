								...
								<div class="wishlist-content">
									<form action="#">
										<div class="wishlist-table table-responsive">
											...
											foreach ($sess as $pos => $info) {
									        foreach ($info as $number) {
									            $liste2=$var->afficherProduitCmp($number);
									      
											$key = array_search($number, $_SESSION['comparateur']);
											...
											foreach ($liste2 as $val) {?>
													...
													<tr>
														...
														<td class="product-add-to-cart" > <?php echo $val['produit_description'];?></td>													
                                            				...
                                            				<td> <a href="<?php echo "supprimer-comparateur.php?suppid=".$key; ?>" >
