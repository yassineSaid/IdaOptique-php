...
<link rel='stylesheet prefetch' href='https://cdnjs.cloudflare.com/ajax/libs/meyer-reset/2.0/reset.min.css'><link rel='stylesheet prefetch' href='https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.2/css/font-awesome.min.css'><link rel="stylesheet" href="chat.css" >
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <form action=ajouter-chat.php method="post">
            ...
            <ul>
                ...
                <li class="contact active">
                    <div class="wrap">
                        ...
                        <div class="meta">
                            <?PHP foreach($listechat as $row){ ?>
                            <p class="name"><?PHP echo $row['pseudo']; ?></p>
                            <p class="preview"><?PHP echo $row['message']; ?></p>
                            <?PHP } ?>
                        </div>
                    </div>
                </li>
...
">  
        ...
        <div class="contact-profile">
         <?php  $listechat2=$chat1->afficherChat($_GET['sid']);
 foreach($listechat2 as $row){ ?>
            <img src="http://emilcarlsson.se/assets/harveyspecter.png" alt="" />
        ...
        <div class="messages">
            <ul>
               ...
               <?php
                        $listechat1=$chat1->afficherChat($_GET['rid']);
                                                                foreach($listechat1 as $row){
                                                            ?>
                <li class="replies">
        ...
        <div class="message-input">
            <div class="wrap">
            <input type="text" name="text_message" placeholder="Write your message..." />
